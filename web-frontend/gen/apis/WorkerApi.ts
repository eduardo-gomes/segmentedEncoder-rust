...
export interface JobJobIdTasksTaskIdInputNumGetRequest {
    num: number;
    jobId: string;
    taskId: string;
}
...
export class WorkerApi extends runtime.BaseAPI {
    ...
    /**
     */
    async jobJobIdTasksTaskIdInputNumGetRaw(requestParameters: JobJobIdTasksTaskIdInputNumGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['num'] == null) {
            throw new runtime.RequiredError(
                'num',
                'Required parameter "num" was null or undefined when calling jobJobIdTasksTaskIdInputNumGet().'
            );
        }
        ...
        if (requestParameters['jobId'] == null) {
            throw new runtime.RequiredError(
                'jobId',
                'Required parameter "jobId" was null or undefined when calling jobJobIdTasksTaskIdInputNumGet().'
            );
        }
        ...
        if (requestParameters['taskId'] == null) {
            throw new runtime.RequiredError(
                'taskId',
                'Required parameter "taskId" was null or undefined when calling jobJobIdTasksTaskIdInputNumGet().'
            );
        }
        ...
        const response = await this.request({
            path: `/job/{job_id}/tasks/{task_id}/input/{num}`.replace(`{${"num"}}`, encodeURIComponent(String(requestParameters['num']))).replace(`{${"job_id"}}`, encodeURIComponent(String(requestParameters['jobId']))).replace(`{${"task_id"}}`, encodeURIComponent(String(requestParameters['taskId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    /**
     */
    async jobJobIdTasksTaskIdInputNumGet(requestParameters: JobJobIdTasksTaskIdInputNumGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.jobJobIdTasksTaskIdInputNumGetRaw(requestParameters, initOverrides);
    }
