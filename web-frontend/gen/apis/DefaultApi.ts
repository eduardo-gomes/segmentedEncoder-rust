...
export class DefaultApi extends runtime.BaseAPI {
     ...
     * List jobs
     */
    async jobGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<string>>> {
     ...
     * List jobs
     */
    async jobGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<string>> {
