...
use status::status_reporter_server::{StatusReporter, StatusReporterServer};
use status::{Empty, ReportResult, StatusReport};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
	...
	let status_reporter_service = StatusKeeper::new();
